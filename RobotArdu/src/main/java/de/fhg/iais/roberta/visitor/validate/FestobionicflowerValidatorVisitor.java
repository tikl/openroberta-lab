...
public final class FestobionicflowerValidatorVisitor extends AbstractProgramValidatorVisitor implements IFestobionicflowerVisitor<Void> {
    ...
    public Void visitLedOnAction(LedOnAction<Void> ledOnAction) {
        if ( ledOnAction.getLedColor().getKind().getName().equals("EMPTY_EXPR") ) { //&& !this.robotConfiguration.isComponentTypePresent(SC.RGBLED) ) {
    ...
    public Void visitStepMotorAction(StepMotorAction<Void> stepMotorAction) {
        if ( stepMotorAction.getStepMotorPos().getKind().getName().equals("EMPTY_EXPR") ) { //&& !this.robotConfiguration.isComponentTypePresent(SC.RGBLED) ) {
